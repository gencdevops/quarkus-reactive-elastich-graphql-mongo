# quarkus-reactive-elastich-graphql-mongo Project
...
You can then execute your native executable with: `./build/quarkus-reactive-elastich-graphql-mongo-1.0-SNAPSHOT-runner`
